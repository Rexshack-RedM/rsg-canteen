...
AddEventHandler('rsg-canteen:server:givefullcanteen', function()
    ...
    TriggerClientEvent('rsg-inventory:client:ItemBox', src, RSGCore.Shared.Items['canteen0'], "remove")
    Player.Functions.AddItem('canteen100', 1)
    TriggerClientEvent('rsg-inventory:client:ItemBox', src, RSGCore.Shared.Items['canteen100'], "add")
end)
